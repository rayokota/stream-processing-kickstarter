...
public abstract class WordCountTest {
  ...
  protected WordCountTest() {
  }

  @BeforeClass
  public static void setupConfigsAndUtils() {
    PRODUCER_CONFIG = Utils.producerConfig(CLUSTER.bootstrapServers(), StringSerializer.class,
        StringSerializer.class, new Properties()
    );
    CONSUMER_CONFIG = Utils.consumerConfig(CLUSTER.bootstrapServers(), "testgroup",
  ...
  protected void runWordCount(WordCount wordCount) throws Exception {
